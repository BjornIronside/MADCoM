...
public:
	...
	// path to population stats file
	string pathToPopstats;
	...
	// Mutation parameters
	// Fraction of initial population generated using Hierarchical Decomposition
	double fractionHD;
	...
	// Probabilities of cutting a link in Route Cutting Off Decomposition
	double goodLinkCutProb; // Default 0.05;
	double poorLinkCutProb; // Default 0.20;
